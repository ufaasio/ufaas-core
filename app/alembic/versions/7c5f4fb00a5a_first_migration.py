...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_permission_business_id'), 'permission', ['business_id'], unique=False)
    ...
    op.create_index(op.f('ix_wallet_business_id'), 'wallet', ['business_id'], unique=False)
    ...
    op.create_index(op.f('ix_transaction_business_id'), 'transaction', ['business_id'], unique=False)
